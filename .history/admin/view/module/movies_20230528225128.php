        ...
        <div class="movie-info">
            ...
            <form action="" method="post" class="form-movies-info">
                <div class="movie-content">
                    <label class="">movie id:</label>
                    <div class="">
                        <input type="text" name="idAction" value="<?php echo $item['id'] ?>" readonly>
                        <span>Read only</span>
                    </div>
                    <label for="titleEdit">Title:</label>
                    <input type="text" id="titleEdit" name="titleEdit" placeholder="Enter your title..." value="<?php echo $item['title'] ?>">
                    <label for="relDateEdit" class="">khởi chiếu:</label>
                    <input type="date" id="relDateEdit" name="relDateEdit" placeholder="Mời nhập ngày khởi chiếu ..." value="<?php echo $item['relDate'] ?>">
                    <label for="genreEdit">Thể loại:</label>
                    <input type="text" id="genreEdit" name="genreEdit" placeholder="Mời nhập thể loại phim ..." value="<?php echo $item['genre'] ?>">
                    <label for="actorEdit">Diễn viên:</label>
                    <input type="text" id="actorEdit" name="actorEdit" placeholder="Mời nhập tên diễn viên ..." value="<?php echo $item['actor'] ?>">
                    <label id="directorEdit">Đạo diễn:</label>
                    <input type="text" id="directorEdit" name="directorEdit" placeholder="Mời nhập tên đạo diễn..." value="<?php echo $item['director'] ?>">
                    <label id="imageEdit">Image:</label>
                    <input type="text" id="imageEdit" name="imageEdit" placeholder="Mời nhập tên đạo diễn..." value="<?php echo $item['image'] ?>">
                </div>
