...
<div class="main-add">
    ...
    <form action="#" method="post" class="form-movies">
        ...
        <button name="movie-add" type="submit" onclick="history.go(-2)" >Add Movies</button>
    </form>
</div>
        ...
        <div class="movie-info">
            ...
            <form action="#" method="post">
                ...
                <div class="movie-action">
                    <button type="submit" name="movie-edit" onclick="history.go(-2)">Edit</button>
                    <button type="submit" name="movie-delete" onclick="history.go(-2)">Delete</button>
                </div>
            </form>
        </div>
