...
<div class="main-show">
    ...
    <div class="movie-info">
        ...
        <div class="movie-content">
            ...
            <input type="text" id="id" name="id" value="<?php echo $item['id'] ?>" readonly>
            <span class="">khởi chiếu:</span>
            <input type="text" name="relDate" placeholder="Mời nhập ngày khởi chiếu ..." value="<?php echo $item['relDate'] ?>">
            <span>Thể loại:</span>
            <input type="text" id="genre" name="genre" placeholder="Mời nhập thể loại phim ..." value="<?php echo $item['genre'] ?>">
            <span>Diễn viên:</span>
            <input type="text" id="actor" name="actor" placeholder="Mời nhập tên diễn viên ..." value="<?php echo $item['actor'] ?>">
            <span>Đạo diễn:</span>
            <input type="text" id="director" name="director" placeholder="Mời nhập tên đạo diễn..." value="<?php echo $item['director'] ?>">
            <span>Image Addre</span>
        </div>
