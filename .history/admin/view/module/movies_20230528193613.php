...
if (isset($_POST['movie-edit'])) {
    $sqlUpdate = "UPDATE movies SET title=:titleEdit, genre=:genreEdit, director=:directorEdit, actor=:actorEdit, relDate=:relDateEdit, image=:imageEdit,  WHERE id=5";
    //Data update
    ...
    $idEditStr = $_POST['idEdit'];
    $idEditInt = intval($_POST['idEdit']);
