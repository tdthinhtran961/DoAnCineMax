...
if (isset($_POST['movie-edit'])) {
    $sqlUpdate = "UPDATE INTO movies SET title=:titleEdit, genre=:genreEdit, director=:directorEdit, actor=:actorEdit, relDate=:relDateEdit, image=:imageEdit,  WHERE id=:id";
    //Data update
