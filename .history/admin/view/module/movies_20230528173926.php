...
<div class="main-add">
    ...
    <form action="" method="post" class="form-movies">
        ...
        <div>
            <label for="reldate" class="label" value="<?php echo $item['relDate'] ?>">RELEASE DATE</label>
...
//update.php
$sqlUpdate = "UPDATE INTO movies SET colA=:colA, conB=:colB WHERE id=:id";
//Data update
$newValueA = "newValueA";
$newValueB = "newValueB";
$idUp = "idUpdate";
...
try {
    ...
    $datasUpdate =  $stmtUpdate -> execute($valuesUpdate);
