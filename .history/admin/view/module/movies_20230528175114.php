...
<div class="main-show">
    ...
    <div class="movie-info">
        ...
        <div class="movie-content">
            ...
            <input type="text" id="reldate" name="relDate" placeholder="Mời nhập ngày khởi chiếu ..." value="<input type="text" id="reldate" name="relDate" placeholder="Mời nhập ngày khởi chiếu ..." >" >
            <span>Thể loại:</span>
