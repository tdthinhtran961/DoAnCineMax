...
<div class="main-add">
    ...
    <form action="" method="post" class="form-movies">
        <div>
            ...
            <input type="text" id="title" name="title" placeholder="Enter your title..." require>
        </div>
        <div>
            <label for="image" class="label">IMAGE</label>
            <input type="text" id="image" name="image" placeholder="Enter your image address..." require>
        </div>
        <div>
            <label for="genre" class="label">GENRE</label>
            <input type="text" id="genre" name="genre" placeholder="Mời nhập thể loại phim ..." require>
        </div>
        <div>
            <label for="director" class="label">DIRECTOR</label>
            <input type="text" id="director" name="director" placeholder="Mời nhập tên đạo diễn ..." require>
        </div>
        <div>
            <label for="actor" class="label">ACTOR</label>
            <input type="text" id="actor" name="actor" placeholder="Mời nhập tên diễn viên ..." require>
        </div>
        <div>
            <label for="reldate" class="label">RELEASE DATE</label>
            <input type="text" id="reldate" name="relDate" placeholder="Mời nhập ngày khởi chiếu ..." require>
        </div>
        <button name="movie-add" type="submit" aria-required="">Add Movies</button>
    </form>
</div>
        ...
        <div class="movie-info">
            ...
            <form action="" method="post">
                <div class="movie-content">
                    ...
                    <span>Title:</span>
                    <input type="text" name="titleEdit" placeholder="Enter your title..." value="<?php echo $item['title'] ?>" require>
                    <span class="">khởi chiếu:</span>
                    <input type="text" name="relDateEdit" placeholder="Mời nhập ngày khởi chiếu ..." value="<?php echo $item['relDate'] ?>" require>
                    <span>Thể loại:</span>
                    <input type="text" name="genreEdit" placeholder="Mời nhập thể loại phim ..." value="<?php echo $item['genre'] ?>" require>
                    <span>Diễn viên:</span>
                    <input type="text" name="actorEdit" placeholder="Mời nhập tên diễn viên ..." value="<?php echo $item['actor'] ?>" require>
                    <span>Đạo diễn:</span>
                    <input type="text" name="directorEdit" placeholder="Mời nhập tên đạo diễn..." value="<?php echo $item['director'] ?>" require>
                    <span>Image:</span>
                    <input type="text" name="imageEdit" placeholder="Mời nhập tên đạo diễn..." value="<?php echo $item['image'] ?>" require>
                </div>
